 ...
 * parameters, overcoming the c/c++ limitation
 */
 // Motion deceleration tuning
struct MotionDecel {
    float slowdownStart = 24.0f; // distance (inches or cm) before target to start slowing
    float minSpeed = 00.0f;      // never drop below this speed
    float maxSpeed = 127.0f;     // typical full speed
    float kDecel = 60.0f;         // larger = more aggressive slowdown
};
